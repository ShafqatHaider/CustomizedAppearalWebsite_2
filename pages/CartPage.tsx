      ...
      <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        {cartItems.length === 0 ? (
          <div className="text-center mt-12">
            ...
            <Link to="/" className="mt-4 inline-block bg-indigo-600 border border-transparent rounded-md py-3 px-8 text-base font-medium text-white hover:bg-indigo-700">
              Continue Shopping
            </Link>
          </div>
        ) : (
                      ...
                      <div className="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                        ...
                        <div className="mt-4 sm:mt-0 sm:pr-9">
                          ...
                          <input
                            ...
                            type="number"
                            className="w-20 rounded-md border border-gray-300 py-1.5 text-base leading-5 font-medium text-gray-700 text-left shadow-sm focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
